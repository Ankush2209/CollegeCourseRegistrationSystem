A Java-based Course Registration System that allows students to register for courses efficiently while ensuring proper slot allocation. Built using Java and JDBC, this project enables:
